...
## Program name:  05_CRP_agegroup_m.R
## Author:        Jiayi Zeng
## R-Version:     4.5.2
## version/ Date: V 1.0/ 2026-04-22
##
## Purpose:       Prevalence calculation of elevated CRP by applying 3mg/L and age-/sex-specific cutoffs at age 1-22.5 (males)
##
...
## *Cutoff file
##"./30_Analysis/CRP/data/All_perc_comb_long_m.csv" [from 03_...]
##
## ***************************************************************************
...
### select males
full_data <- subset(full_data, sex == 1)
...
## load the dataset
cutoff <- read.csv("./30_Analysis/CRP/data/All_perc_comb_long_m.csv")[, c("global.age", "global.Perc_comb_90","global.Perc_comb_cutoff")]
...
by_age <- ana_data_m %>%
  ...
  summarise(
    n = n(),
    prop_p93.5 = percent(mean(crp_high, na.rm = TRUE), accuracy = 0.01),
...
write_xlsx(results, "./30_Analysis/CRP/results/Table2_cutoff_m.xlsx")